...
```{r sampling-dist}
# type your code for the Exercise here, and Run Document
# a total of 15,000 elements are in vector sample_means50
# the sampling distribution is a nearly normal with the center equal to mu 1,500
...
sample_means_small <- ames %>%
                    ...
                    summarise(x_bar = mean(area))
sample_means_small
# 25 elements are in the vector sample_means_small, each element represent a sample mean of sample of size 10
